...
void InitialiseSuperBlock()
{
    ...
    printf("Pallavi CVFS : Super block gets initialised succesfully\n");
}
...
void CreateDILB()
{
    ...
    printf("Pallavi CVFS : DILB created succesfully\n");
}
...
void StartAuxillaryDataInitilisation()
{
    ...
    printf("Pallavi CVFS : Auxillary data initialised succesfully\n");
}
...
void DisplayHelp()
{
    ...
    printf("exit   : It is used to terminate Pallavi CVFS\n");
...
void LsFile()
{
    ...
    printf("-----------------------------------------------\n");
    printf("-------- Pallavi CVFS Files Information -------\n");
    printf("-----------------------------------------------\n");
...
int main()
{
    ...
    printf("-----------------------------------------------\n");
    printf("------- Pallavi CVFS started succesfully ------\n");
    printf("-----------------------------------------------\n");
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Pallavi CVFS\n");
        ...
        {
            // Pallavi CVFS : > creat Ganesh.txt 3
